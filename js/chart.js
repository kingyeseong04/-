...
(function (global) {
  ...
  class Chart {
    ...
    // Video-frame look: hide the price-number axis AND the time axis, but keep
    // the grid (horizontal + our vertical 12-candle lines) so the background
    // still shows the chart lines — just no axis labels.
    setFrameLook(on) {
